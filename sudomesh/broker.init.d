...
DAEMON_ARGS='-m broker.main /opt/tunneldigger/broker/l2tp_broker.cfg'
...
do_start()
{
        ...
        echo "start-stop-daemon --start --pidfile \"$PIDFILE\" $START_OPTS $STARTSTOP_OPTS -- $DAEMON_ARGS || return 2" > /tmp/foo2
